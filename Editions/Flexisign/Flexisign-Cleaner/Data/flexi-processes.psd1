...
@{
	Processes = @(
		@{
			...
			ConfirmationMessage = "FlexiPRINT está abierto. ¿Forzar cierre? (puede perder trabajos en curso) [S/N]"
			Scope               = 'Initial'
		...
		@{
			...
			CloseGracefully     = $true
			RequireConfirmation = $true
			ConfirmationMessage = "PrintExpert está abierto. ¿Forzar cierre? (puede perder trabajos en curso) [S/N]"
			Scope               = 'Initial'
			ReopenAfterClean    = $true
		}
